...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,832 | 🐛 296 | 🌐 Rust | 📅 2026-08-28 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,396 | 🐛 34 | 🌐 Rust | 📅 2026-08-28 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
