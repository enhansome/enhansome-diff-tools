...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,903 | 🐛 291 | 🌐 Rust | 📅 2026-09-14 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,401 | 🐛 34 | 🌐 Rust | 📅 2026-09-15 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,196 | 🐛 441 | 🌐 Rust | 📅 2026-09-15 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,089 | 🐛 5 | 🌐 Perl | 📅 2026-09-14 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,486 | 🐛 24 | 🌐 Python | 📅 2026-09-15 - Semantic diff for JSON, JSON5, XML, HTML, YAML, CSV.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,186 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-15 - Compares the content of APKs, AABs, AARs, and JARs.
