...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,839 | 🐛 296 | 🌐 Rust | 📅 2026-08-28 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,396 | 🐛 34 | 🌐 Rust | 📅 2026-08-29 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,977 | 🐛 432 | 🌐 Rust | 📅 2026-08-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,185 | 🐛 28 | 🌐 Kotlin | 📅 2026-08-29 - Compares the content of APKs, AABs, AARs, and JARs.
