...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,916 | 🐛 288 | 🌐 Rust | 📅 2026-09-18 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,402 | 🐛 34 | 🌐 Rust | 📅 2026-09-19 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,243 | 🐛 443 | 🌐 Rust | 📅 2026-09-19 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,089 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
* [icdiff](https://github.com/jeffkaufman/icdiff) ⭐ 4,386 | 🐛 26 | 🌐 Python | 📅 2026-02-08 - Standalone application for side-by-side diffs with syntax highlighting.
...
* [jd](https://github.com/josephburnett/jd) ⭐ 2,304 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,882 | 🐛 71 | 🌐 Go | 📅 2026-09-14 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,187 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-17 - Compares the content of APKs, AABs, AARs, and JARs.
