...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,863 | 🐛 293 | 🌐 Rust | 📅 2026-09-06 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,397 | 🐛 34 | 🌐 Rust | 📅 2026-09-07 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
* [gumtree](https://github.com/GumTreeDiff/gumtree) ⭐ 1,334 | 🐛 24 | 🌐 Java | 📅 2026-09-07 - Web/GUI/Text frontend to generate side-by-side diffs, hides style changes and detects moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,111 | 🐛 435 | 🌐 Rust | 📅 2026-09-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,090 | 🐛 5 | 🌐 Perl | 📅 2026-08-31 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,480 | 🐛 29 | 🌐 Python | 📅 2026-09-07 - Semantic diff for JSON, JSON5, XML, HTML, YAML, CSV.
* [jd](https://github.com/josephburnett/jd) ⭐ 2,298 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,882 | 🐛 70 | 🌐 Go | 📅 2026-08-31 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
...
* [migra](https://github.com/djrobstep/migra) ⭐ 3,052 | 🐛 88 | 🌐 Python | 📅 2025-08-25 - Compares the schema of PostgreSQL databases and generates migrations.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,185 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-07 - Compares the content of APKs, AABs, AARs, and JARs.
