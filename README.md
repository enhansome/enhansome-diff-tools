...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,766 | 🐛 290 | 🌐 Rust | 📅 2026-08-13 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,395 | 🐛 35 | 🌐 Rust | 📅 2026-08-13 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
* [gumtree](https://github.com/GumTreeDiff/gumtree) ⭐ 1,329 | 🐛 22 | 🌐 Java | 📅 2026-08-10 - Web/GUI/Text frontend to generate side-by-side diffs, hides style changes and detects moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,745 | 🐛 424 | 🌐 Rust | 📅 2026-08-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,082 | 🐛 3 | 🌐 Perl | 📅 2026-08-11 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [jd](https://github.com/josephburnett/jd) ⭐ 2,293 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,870 | 🐛 69 | 🌐 Go | 📅 2026-08-13 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
* [OpenAPI-diff](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,096 | 🐛 79 | 🌐 Java | 📅 2026-08-11 - Utility for comparing two OpenAPI specifications.
...
* [daff](https://github.com/paulfitz/daff) ⭐ 921 | 🐛 47 | 🌐 Java | 📅 2026-05-27 - Library for comparing tables format such as csv files.
