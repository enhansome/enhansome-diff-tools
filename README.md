...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,918 | 🐛 288 | 🌐 Rust | 📅 2026-09-18 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,403 | 🐛 34 | 🌐 Rust | 📅 2026-09-20 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,280 | 🐛 444 | 🌐 Rust | 📅 2026-09-19 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,090 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [jd](https://github.com/josephburnett/jd) ⭐ 2,305 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
