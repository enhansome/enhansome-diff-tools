...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,861 | 🐛 293 | 🌐 Rust | 📅 2026-09-06 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,397 | 🐛 34 | 🌐 Rust | 📅 2026-09-06 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,101 | 🐛 435 | 🌐 Rust | 📅 2026-09-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
