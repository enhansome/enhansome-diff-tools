...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,821 | 🐛 298 | 🌐 Rust | 📅 2026-08-25 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,395 | 🐛 34 | 🌐 Rust | 📅 2026-08-26 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,185 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-26 - Compares the content of APKs, AABs, AARs, and JARs.
