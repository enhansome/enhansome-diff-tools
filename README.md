...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,843 | 🐛 296 | 🌐 Rust | 📅 2026-08-28 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,396 | 🐛 34 | 🌐 Rust | 📅 2026-08-30 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,024 | 🐛 433 | 🌐 Rust | 📅 2026-08-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,185 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-30 - Compares the content of APKs, AABs, AARs, and JARs.
