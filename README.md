...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,918 | 🐛 289 | 🌐 Rust | 📅 2026-09-18 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,403 | 🐛 34 | 🌐 Rust | 📅 2026-09-21 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,294 | 🐛 446 | 🌐 Rust | 📅 2026-09-19 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,883 | 🐛 71 | 🌐 Go | 📅 2026-09-21 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
...
* [migra](https://github.com/djrobstep/migra) ⭐ 3,048 | 🐛 88 | 🌐 Python | 📅 2025-08-25 - Compares the schema of PostgreSQL databases and generates migrations.
