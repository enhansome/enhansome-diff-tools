...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,844 | 🐛 296 | 🌐 Rust | 📅 2026-08-28 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,397 | 🐛 34 | 🌐 Rust | 📅 2026-08-31 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
* [gumtree](https://github.com/GumTreeDiff/gumtree) ⭐ 1,334 | 🐛 23 | 🌐 Java | 📅 2026-08-31 - Web/GUI/Text frontend to generate side-by-side diffs, hides style changes and detects moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,045 | 🐛 433 | 🌐 Rust | 📅 2026-08-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,084 | 🐛 4 | 🌐 Perl | 📅 2026-08-31 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,878 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,185 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-31 - Compares the content of APKs, AABs, AARs, and JARs.
