...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,854 | 🐛 293 | 🌐 Rust | 📅 2026-09-04 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,397 | 🐛 34 | 🌐 Rust | 📅 2026-09-03 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
* [gumtree](https://github.com/GumTreeDiff/gumtree) ⭐ 1,334 | 🐛 22 | 🌐 Java | 📅 2026-09-03 - Web/GUI/Text frontend to generate side-by-side diffs, hides style changes and detects moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,076 | 🐛 434 | 🌐 Rust | 📅 2026-09-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,089 | 🐛 4 | 🌐 Perl | 📅 2026-08-31 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,480 | 🐛 29 | 🌐 Python | 📅 2026-08-04 - Semantic diff for JSON, JSON5, XML, HTML, YAML, CSV.
* [jd](https://github.com/josephburnett/jd) ⭐ 2,298 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,881 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
* [OpenAPI-diff](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,096 | 🐛 83 | 🌐 Java | 📅 2026-09-03 - Utility for comparing two OpenAPI specifications.
* [xcdiff](https://github.com/bloomberg/xcdiff) ⭐ 960 | 🐛 10 | 🌐 Swift | 📅 2026-03-08 - Terminal utility to find differences between two .xcodeproj project files.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,185 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-31 - Compares the content of APKs, AABs, AARs, and JARs.
