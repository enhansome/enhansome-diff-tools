...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,934 | 🐛 289 | 🌐 Rust | 📅 2026-09-22 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,403 | 🐛 34 | 🌐 Rust | 📅 2026-09-25 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
* [gumtree](https://github.com/GumTreeDiff/gumtree) ⭐ 1,336 | 🐛 23 | 🌐 Java | 📅 2026-09-25 - Web/GUI/Text frontend to generate side-by-side diffs, hides style changes and detects moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,348 | 🐛 452 | 🌐 Rust | 📅 2026-09-19 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,096 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
...
* [ydiff](https://github.com/ymattw/ydiff) ⭐ 934 | 🐛 1 | 🌐 Python | 📅 2026-05-20 - Pager for git diff, supports unified and side-by-side view, highlights inline changes.
...
* [diffr](https://github.com/mookid/diffr) ⭐ 617 | 🐛 14 | 🌐 Rust | 📅 2026-01-08 - Pager for git diff, changes colors and highlights inline changes.
* [riff](https://github.com/walles/riff) ⭐ 527 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - Wrapper around (`git`) `diff` highlighting which parts of lines that changed.

## Other Text Formats

Diff utilities for non-code based text formats.

* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,486 | 🐛 22 | 🌐 Python | 📅 2026-09-24 - Semantic diff for JSON, JSON5, XML, HTML, YAML, CSV.
* [jd](https://github.com/josephburnett/jd) ⭐ 2,307 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,886 | 🐛 71 | 🌐 Go | 📅 2026-09-21 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
* [OpenAPI-diff](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,096 | 🐛 85 | 🌐 Java | 📅 2026-09-04 - Utility for comparing two OpenAPI specifications.
* [xcdiff](https://github.com/bloomberg/xcdiff) ⭐ 961 | 🐛 10 | 🌐 Swift | 📅 2026-09-22 - Terminal utility to find differences between two .xcodeproj project files.
* [daff](https://github.com/paulfitz/daff) ⭐ 925 | 🐛 47 | 🌐 Java | 📅 2026-05-27 - Library for comparing tables format such as csv files.
* [prettier-diff](https://github.com/josephfrazier/prettier-diff) ⭐ 36 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-13 - Wrapper around git diff for JavaScript/JSON, preprocesses the data with a prettifier.
...
* [migra](https://github.com/djrobstep/migra) ⭐ 3,047 | 🐛 88 | 🌐 Python | 📅 2025-08-25 - Compares the schema of PostgreSQL databases and generates migrations.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,188 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-25 - Compares the content of APKs, AABs, AARs, and JARs.
