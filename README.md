...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,932 | 🐛 289 | 🌐 Rust | 📅 2026-09-22 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,403 | 🐛 34 | 🌐 Rust | 📅 2026-09-24 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
* [gumtree](https://github.com/GumTreeDiff/gumtree) ⭐ 1,336 | 🐛 23 | 🌐 Java | 📅 2026-09-24 - Web/GUI/Text frontend to generate side-by-side diffs, hides style changes and detects moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,329 | 🐛 452 | 🌐 Rust | 📅 2026-09-19 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
* [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) ⭐ 18,094 | 🐛 5 | 🌐 Perl | 📅 2026-09-19 - Pager for (git) diff, changes colors and highlights inline changes, various options to customize output format.
