...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,855 | 🐛 293 | 🌐 Rust | 📅 2026-09-04 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,397 | 🐛 34 | 🌐 Rust | 📅 2026-09-04 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,082 | 🐛 434 | 🌐 Rust | 📅 2026-09-02 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
...
* [dyff](https://github.com/homeport/dyff) ⭐ 1,882 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
...
* [diffuse](https://github.com/JakeWharton/diffuse) ⭐ 2,186 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-04 - Compares the content of APKs, AABs, AARs, and JARs.
