...
* [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,892 | 🐛 292 | 🌐 Rust | 📅 2026-09-13 - Terminal utility to generate side-by-side diffs, hides style changes and supports many languages, but doesn't detect moved code.
* [diffsitter](https://github.com/afnanenayet/diffsitter) ⭐ 2,398 | 🐛 34 | 🌐 Rust | 📅 2026-09-13 - Terminal utility to generate unified diffs, hides style changes, but doesn't detect moved code.
...
* [delta](https://github.com/dandavison/delta) ⭐ 32,176 | 🐛 441 | 🌐 Rust | 📅 2026-09-13 - Pager for (git) diff, adds syntax highlighting, inline and side-by-side view, support for git blame and merge conflicts.
...
* [riff](https://github.com/walles/riff) ⭐ 525 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - Wrapper around (`git`) `diff` highlighting which parts of lines that changed.

## Other Text Formats

Diff utilities for non-code based text formats.

* [Graphtage](https://github.com/trailofbits/graphtage) ⭐ 2,484 | 🐛 22 | 🌐 Python | 📅 2026-09-09 - Semantic diff for JSON, JSON5, XML, HTML, YAML, CSV.
* [jd](https://github.com/josephburnett/jd) ⭐ 2,302 | 🐛 20 | 🌐 Go | 📅 2026-04-22 - Creates diffs for JSON/YAML files, also supports patching.
* [dyff](https://github.com/homeport/dyff) ⭐ 1,883 | 🐛 70 | 🌐 Go | 📅 2026-09-11 - Pager for git diff (or standalone) for YAML/JSON, enhances display of changes and their location.
